...
{ Graphics32 }
  GR32_Image, GR32_Layers, GR32_RangeBars, 
{ GraphicsMagic Lib }
  gmTypes,
...
var
  ...
  LFileExt : string;
begin
  LFileName := frmGradientPicker.DrawingToolGradientListState.FileName;
  ...
  with frmGradientPicker.DrawingToolGradientListState do
  begin
    FileName    := LFileName;
    UseInternal := False;
  ...
  WriteInfoToIniFile(
    ...
    IntToStr(frmGradientPicker.DrawingToolGradientListState.SelectedIndex) );
end;
...
var
  ...
  LFileExt : string;
begin
  LFileName := frmGradientPicker.MapCommandGradientListState.FileName;
  ...
  with frmGradientPicker.MapCommandGradientListState do
  begin
    FileName      := LFileName;
    UseInternal   := False;
  ...
  WriteInfoToIniFile(
    ...
    IntToStr(frmGradientPicker.MapCommandGradientListState.SelectedIndex) );
end;
...
begin
  LFileName := frmGradientPicker.FillLayerGradientListState.FileName;
  ...
  with frmGradientPicker.FillLayerGradientListState do
  begin
    FileName      := LFileName;
    UseInternal   := False;
  ...
  begin
    ...
    LGradientFillLayerPanel.Gradient := frmGradientPicker.GetFillLayerGradient;
  ...
  WriteInfoToIniFile(
    ...
    IntToStr(frmGradientPicker.FillLayerGradientListState.SelectedIndex) );
end;
...
begin
  LFileName := frmGradientPicker.MapLayerGradientListState.FileName;
  ...
  with frmGradientPicker.MapLayerGradientListState do
  begin
    FileName      := LFileName;
    UseInternal   := False;
  ...
  begin
    ...
    LGradientMapLayerPanel.Gradient := frmGradientPicker.GetMapLayerGradient;
  ...
  WriteInfoToIniFile(
    ...
    IntToStr(frmGradientPicker.MapLayerGradientListState.SelectedIndex) );
end;
