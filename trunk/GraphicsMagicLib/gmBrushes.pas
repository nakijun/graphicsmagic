...
{$RANGECHECKS OFF}
  ...
  begin
    ...
    or (SampleY   < 0) or (SampleY   >= FHistoryBitmap.Height)
    then Continue
    else
    begin
      ForeRow := FHistoryBitmap.ScanLine[SampleY];
    ...
    begin
      ...
      or (SampleX   < 0) or (SampleX   >= FHistoryBitmap.Width)
      then Continue
      else
      begin
        MaskIntensity := MaskRow[i] and $FF;
        ...
        fa := ForeRow[SampleX] shr 24 and $FF;
        ...
        begin
          ...
          begin
            ...
            BlendColor := RGBBlendByMode(ForeRow[SampleX], BackRow[CurPaintX], AdjustedOpacity, FBlendMode);
          ...
          begin
            ...
            if RGBChannelCount = 3 then
            begin
              BlendColor := ARGBBlendByMode(ForeRow[SampleX], BackRow[CurPaintX], FOpacityWeight, FBlendMode);
