...
const
  ...
  CURVES_FILE_MARK    = 'GraphicsMagic Curves';
...
begin
  ...
  begin
    ...
    try
      ...
      if LFileHeader.Mark <> CURVES_FILE_MARK then
      begin
      ...
      begin
        if LFileHeader.Version > CURVES_FILE_VERSION then
        begin
          FOutputMsg := 'Cannot open the file "' + ExtractFileName(AFileName) + '",' + #10#13 +
...
begin
  ...
  begin
    ...
    LFileHeader.Mark    := CURVES_FILE_MARK;
