...
{ GraphicsMagic Package Lib }
  gmGradient, gmGridBased_List, gmGradient_List, gmGradientsGrid,
  gmGridBased_FileDlg, gmGradient_FileDlgs;
...
type
  ...
  public
    ...
    property DrawingToolGradientListState: TgmGradientListState read FDrawingToolGradientListState;
    property MapCommandGradientListState : TgmGradientListState read FMapCommandGradientListState;
    property FillLayerGradientListState  : TgmGradientListState read FFillLayerGradientListState;
    property MapLayerGradientListState   : TgmGradientListState read FMapLayerGradientListState;
  end;
...
begin
  ...
  begin
    ...
    LGradientFillLayerPanel.Gradient.GradientLength := frmGradientFill.imgSelectedGradient.Bitmap.Width;
    LGradientFillLayerPanel.Gradient.RefreshColorArray;
    
    LGradientFillLayerPanel.Gradient.DrawColorGradients(
      frmGradientFill.imgSelectedGradient.Bitmap,
      LGradientFillLayerPanel.IsReversed);
...
begin
  ...
  UpdateMapCommandGradients;  // Gradient Map Command
  UpdateFillLayerGradients;   // Gradient Layer
  ...
  case FGradientUser of
    ...
    guGradientFillLayer:
      begin
        ...
        LGradientFillLayerPanel := TgmGradientFillLayerPanel(ActiveChildForm.LayerPanelList.SelectedLayerPanel);
        LGradientFillLayerPanel.Gradient := GetFillLayerGradient;
    ...
    guGradientMapLayer:
      begin
        ...
        LGradientMapLayerPanel.Gradient := GetMapLayerGradient;

        if frmGradientMap.chckbxPreview.Checked then
        begin
          LGradientMapLayerPanel.Update;
        end;
            ...
            mrNo:
              begin
                ...
                LGradientFillLayerPanel :=
                  TgmGradientFillLayerPanel(ActiveChildForm.LayerPanelList.SelectedLayerPanel);
            ...
            mrNo:
              begin
                ...
                LGradientMapLayerPanel :=
                  TgmGradientMapLayerPanel(ActiveChildForm.LayerPanelList.SelectedLayerPanel);
        ...
        case FGradientUser of
          ...
          guGradientFillLayer:
            begin
              ...
              LGradientFillLayerPanel.Gradient := Self.GetFillLayerGradient;
              LGradientFillLayerPanel.Update;
            end;
          ...
          guGradientMapLayer:
            begin
              ...
              LGradientMapLayerPanel.Gradient := Self.GetMapLayerGradient;
