...
begin
  ...
  Count := Size;
  Stream.ReadBuffer(List^, Count * SizeOf(Integer));
end;
...
begin
  ...
  Stream.WriteBuffer(List^, Count * SizeOf(Integer));
end;
...
begin
  ...
  begin
    ...
    im.iItem := Index;
    SendMessage(WindowHandle, LVM_SETINSERTMARK, 0, Integer(@im));
  end;
end;
  ...
  begin
    ...
    try
      ...
      try
        ...
        GdipDrawImageRectRect(Graphics, Image, Rect.Left, Rect.Top,
          Rect.Right - Rect.Left, Rect.Bottom - Rect.Top, 0, 0,
          ImageWidth, ImageHeight, UntiPixels, nil, nil, nil);
      finally
        GdipDisposeImage(Image);
      end;
    finally
