...
type
  ...
  public
    property ChannelName: string write SetChannelName;
  end;
...
procedure TfrmDuplicateChannel.SetChannelName(const AValue: string);
begin
  lblDuplicateChannelName.Caption := lblDuplicateChannelName.Caption + ' ' + AValue;
  edtDuplicateChannelAs.Text      := AValue + ' copy';
end; 
