...
begin
  ...
  begin
    ...
    with imgDrawingArea.GetViewportRect do
      LocalCenterPoint := imgDrawingArea.ControlToBitmap(  Point( (Right + Left) div 2, (Top + Bottom) div 2 )  );

    // set location of the layer
    FMeasureLayer.Location := FloatRect(LocalCenterPoint.X - LayerHalfW, LocalCenterPoint.Y - LayerHalfH,
                                        LocalCenterPoint.X + LayerHalfW, LocalCenterPoint.Y + LayerHalfH);
...
{ Mouse left button up }
  ...
  begin
    ...
    begin
      ...
      try
        LGradientRender.ColorGradient := frmGradientPicker.glDrawingToolGradients.Items[frmGradientPicker.FDrawingToolGradientListState.SelectedIndex];
...
begin
  ...
  begin
    ...
    with FSelectionHandleLayer do
    begin
      Location := FloatRect(LocalCenterPoint.X - LayerHalfW, LocalCenterPoint.Y - LayerHalfH,
                            LocalCenterPoint.X + LayerHalfW, LocalCenterPoint.Y + LayerHalfH);
