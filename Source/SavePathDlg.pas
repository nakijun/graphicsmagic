...
begin
  if ActiveChildForm.PathPanelList.SelectedPanel.IsNamed then
  begin
    edtPathName.Text := ActiveChildForm.PathPanelList.SelectedPanel.PathName;
  end
  else
  begin
    edtPathName.Text := 'Path ' + IntToStr(ActiveChildForm.PathPanelList.PathPanelNumber + 1);
  end;
