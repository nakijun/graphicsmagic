...
uses
  ...
  procedure DrawPolyLine(const ACanvas: TCanvas; const APointArray: array of TPoint;
    const APenMode: TPenMode);
...
procedure DrawHorizontalLine(ACanvas: TCanvas; const AStartX, Y, AEndX: Integer;
  const APenMode: TPenMode);
var
  LTempPenMode: TPenMode;
begin
