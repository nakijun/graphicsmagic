...
begin
  ...
  bR := (fR * AOpacity + bR * Cardinal(255 - AOpacity)) div 255;
  bG := (fG * AOpacity + bG * Cardinal(255 - AOpacity)) div 255;
  bB := (fB * AOpacity + bB * Cardinal(255 - AOpacity)) div 255;
