...
uses
  ...
  StdCtrls, Buttons, ExtCtrls, ImgList, gmTypes;
...
begin
  ...
  try
    FCurrentWidth                 := TBitmapLayer(ActiveChildForm.imgDrawingArea.Layers[0]).Bitmap.Width;
    FCurrentHeight                := TBitmapLayer(ActiveChildForm.imgDrawingArea.Layers[0]).Bitmap.Height;
